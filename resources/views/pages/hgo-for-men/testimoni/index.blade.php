...
@section('content')
    <div class="container mt-5">
        ...
        <h4 class="mb-4">Daftar Tetimoni</h4>
        ...
        <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#addModal">
            <i class="bi bi-plus-circle me-1"></i> Tambah Tetimoni
        </button>

        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <form action="{{ route('hgfm.sections.testimoni.store') }}" method="POST" enctype="multipart/form-data"
                    class="modal-content">
                    @csrf
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="addModalLabel">Tambah Tetimoni</h5>
        ...
        @foreach ($data as $row)
            <div class="modal fade" id="editModal{{ $row->id }}" tabindex="-1"
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <form action="{{ route('hgfm.sections.testimoni.put', $row->id) }}" method="POST"
                        enctype="multipart/form-data" class="modal-content">
                        @csrf
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title" id="editModalLabel{{ $row->id }}">Edit Tetimoni</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body px-4 py-3">
                            <div class="mb-3">
        ...
        <table id="testimoniTable" class="table table-striped">
            <thead>
                <tr>
                    <th>Image</th>
                    <th>Judul</th>
                ...
                @foreach ($data as $row)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('hgfm.sections.testimoni.destroy', $row->id) }}" method="POST"
