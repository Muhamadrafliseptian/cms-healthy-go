...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{ route('hgfm.sections.store', ['id' => '3']) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control summernote" id="description" name="description">{{ old('description', $section['description'] ?? '') }}</textarea>
            </div>
